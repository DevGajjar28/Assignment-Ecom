          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              <Popover.Group className="hidden lg:ml-8 lg:block lg:self-stretch">
               ...
               {/* Search */}
               <div className="flex lg:flex-1 lg:items-center lg:justify-center"> {/* Remove hidden class */}
                <div className="flex items-center w-full max-w-md mx-auto bg-gray-100 rounded-md">
                  ...
                  />
                  <MagnifyingGlassIcon className="h-6 w-6 text-gray-400 mr-4" aria-hidden="true" />
                </div>
              </div>
